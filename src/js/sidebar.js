...
var realArrayCapas = [
    ...
    {'nombre':'Zonas Covid', 'colorFill':'rgba(250,242,183,0.60)', 'colorStoker':'#e7c48c', 'nombreCampo':'Zona_II', 'capa':'zonas_covid_poligonos', 'gejson':'https://cartografia.xalapa.gob.mx/geoserver/zonas_covid_poligonos/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=zonas_covid_poligonos%3Azonas_covid&maxFeatures=500&outputFormat=application%2Fjson&srsname=EPSG:3857'},
    ...
    {'nombre':'Centros Masivos', 'colorFill':'rgba(245,225,222,0.60)', 'colorStoker':'#F2070B', 'nombreCampo':'Name', 'capa':'centros_masivos_puntos', 'gejson':'https://cartografia.xalapa.gob.mx/geoserver/centros_masivos_puntos/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=centros_masivos_puntos%3Acentros_masivos_puntos&maxFeatures=500&outputFormat=application%2Fjson&srsname=EPSG:3857'},
    {'nombre':'Escuelas Sedes', 'colorFill':'rgba(245,225,222,0.60)', 'colorStoker':'#F2070B', 'nombreCampo':'Name', 'capa':'escuelas_sedes_puntos', 'gejson':'https://cartografia.xalapa.gob.mx/geoserver/escuelas_sedes_puntos/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=escuelas_sedes_puntos%3Aescuelas_sedes_puntos&maxFeatures=500&outputFormat=application%2Fjson&srsname=EPSG:3857'},
];
var map;
